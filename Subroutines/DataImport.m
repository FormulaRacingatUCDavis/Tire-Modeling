...
if strcmp( Ext, '.mat')   
    ...
    Data.Source.Run = str2double( FileName(RunIdx+3) );
    
    Data.Time = Raw.ET'; % ET: Elapsed Time [s]
    
    Data.Pressure = Raw.P' * 0.145037737730217; % P: Pressure [psi]
    Data.Camber = Raw.IA'; % IA: Inclination Angle [deg]
    ...
    Data.Force(3,:) = abs(Raw.FZ); % FZ: Normal Force [N]
