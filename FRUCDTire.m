classdef FRUCDTire
    ...
    methods
        ...
        function [Fx, Fy, Mz, Mx] = ...
                EvaluateTire( obj, Alpha, Kappa, Fz, Pi, Gam, Side, CombinedMode )   
            % Slip Angle Conversion
            Alpha = deg2rad(Alpha);
            
            % Evaluate Pure Slip Forces
        ...
        function [Fy, By, Cy, Kya, Hy, Vy, Alpha0] = Fy0MF6_1( obj, Alpha, ~, Fz, Pi, Gam, Side )
            ...
            % Compensating for Tire Mounting Side
            if Side == 'L'
        ...
        % Evaluate Pure Slip Aligning Moment
